...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QRect(10, 9, 830, 256))
        self.lbl_description = QLabel(self.groupBox_2)
        self.lbl_description.setObjectName(u"lbl_description")
        self.lbl_description.setGeometry(QRect(10, 20, 576, 226))
        ...
        self.lbl_thumbnail.setGeometry(QRect(604, 20, 225, 225))
        self.groupBox = QGroupBox(self.centralwidget)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 275, 830, 41))
